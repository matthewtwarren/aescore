...
def finetuneparser():
    ...
    argarse.Namespace
        Parsed arguments
    """
    parser = ap.ArgumentParser(description="Fine tune affinity prediction model.")
    ...
    parser.add_argument("-f", "--freeze", type=int, nargs="+", default=None, help="Layers to freeze (zero indexed)")
